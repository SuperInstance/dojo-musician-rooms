...
Musicians as Plato rooms — vibe embeddings generate MIDI patterns, shape sound by ear
...
```bash
git clone https://github.com/SuperInstance/dojo-musician-rooms
cd dojo-musician-rooms
```
